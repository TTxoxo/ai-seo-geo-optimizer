...
require_once AI_SEO_GEO_PATH . 'includes/class-style-rules-manager.php';
require_once AI_SEO_GEO_PATH . 'includes/class-structured-output-manager.php';
...
require_once AI_SEO_GEO_PATH . 'includes/class-editor-detector.php';
require_once AI_SEO_GEO_PATH . 'includes/class-output-format-manager.php';
require_once AI_SEO_GEO_PATH . 'includes/class-readability-analyzer.php';
require_once AI_SEO_GEO_PATH . 'includes/class-internal-link-manager.php';
require_once AI_SEO_GEO_PATH . 'includes/class-image-alt-manager.php';
require_once AI_SEO_GEO_PATH . 'includes/class-schema-review-manager.php';
require_once AI_SEO_GEO_PATH . 'includes/class-optimizer.php';
require_once AI_SEO_GEO_PATH . 'includes/class-review-manager.php';
require_once AI_SEO_GEO_PATH . 'includes/class-revision-manager.php';
require_once AI_SEO_GEO_PATH . 'includes/class-seo-meta-adapter.php';
